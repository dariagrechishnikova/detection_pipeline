...
yolo_conv_residial_params = {
  ...
  'net_info_path': '/content/drive/MyDrive/Sartorius/detection_pipeline_outputs/network_info/', 
  'model_checkpoints_path': '/content/drive/MyDrive/Sartorius/detection_pipeline_outputs/model_checkpoints',
  'input_callbacks': [ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=5),EarlyStopping(monitor='val_loss', patience=10, restore_best_weights=True)]
}
...
params_dict = {'yolo_conv_residial' : yolo_conv_residial_params, 'dummy' : dummy_params}
